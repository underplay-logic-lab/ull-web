...
type Resp = { days: number; targetMargin: number; overRatio: number; underRatio: number; rows: Row[] };
  ...
  return (
    <section className="mb-8">
      <div className="mb-1 flex items-center justify-between">
        <h3 className="text-sm font-semibold text-foreground">LoRA の見積もりと実績（1 step 秒数の点検）</h3>
        <button
          type="button"
          onClick={() => void load()}
