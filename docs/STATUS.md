...
**残り（この順で）**
0. **Multi-Angle サブ参照の実測（2026-09-23 夜）**: B200・同一コンテナで サブ 0 枚 22.5s/構図、3 枚 62.7s/構図（×2.79）、
   VRAM 56.5 → 58.8GB。課金係数 3.1 は 1 割安全側。**サブ 1 枚・2 枚は未測定**（線形性の確認用に 2 本、合計 150C 弱）。
